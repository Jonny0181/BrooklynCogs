...
class Welcomer:
    ...
    async def status(self, ctx):
        ...
        e.add_field(name="Join Toggle:", value=db[server.id]["Join"].replace("False", "Disabled").replace("True", "Enabled"))
        e.add_field(name="Leave Toggle:", value=db[server.id]["Leave"].replace("False", "Disabled").replace("True", "Enabled"))
        e.add_field(name="Bot Role:", value=db[server.id]["Botrole"].replace("None", "No role set."))
        e.add_field(name="Bot Role Toggle:", value=db[server.id]["Botrolet"].replace("False", "Disabled").replace("True", "Enabled"))
