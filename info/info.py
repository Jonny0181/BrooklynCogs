...
`2)` Server Hosting. | I have moved Brooklyn to a faster and better server so we should not have very many problems anymore. If you experience any really bad lag or anything please let me know!""")
        ...
        try:
            await self.bot.whisper(embed=e)
    ...
    async def announce(self, ctx, message : str):
        ...
        failedservers = []
        blockedservers = ['110373943822540800', '133049272517001216', '267855028914618369', '209814152288403457', '234361176157323265', '246666725448351746', '277303282827788289', '197520956976005121', '273922260291813378', '279913889330757633', '275797729395998720', '281213173598650370']
