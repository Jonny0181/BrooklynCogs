...
class speedtest:
    ...
    async def speedtest(self, ctx):
        try:
            ...
            message12 = await self.bot.say(embed=discord.Embed(description=":stopwatch: **Running speedtest. This may take a while!** :stopwatch:", colour=author.colour))
            ...
            await self.bot.edit_message(message12, embed=embed)
        except KeyError:
